...
//! sockets** on loopback — the same engine the iroh path uses, just with the UDP
//! transport instead. No root, no TUN. Demonstrates that the `Transport`
//! abstraction works over an actual socket, end to end.
//!
