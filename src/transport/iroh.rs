...
//!
//! A WireGuard packet becomes one iroh *unreliable QUIC datagram* so we don't 
//! stack QUIC's retransmission on top of WireGuard's own loss handling. 
//! iroh resolves the NodeId (via the mainline DHT and/or the n0
...
/// to dial by NodeId. It is stateless name resolution, not a control server
///
